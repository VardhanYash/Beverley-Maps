...
static constexpr color BEIGE(0x60,0x60, 0x56, 190);
static constexpr color GMAPSPARK(0xC5, 0xE8, 0xC5);
static constexpr color BEACH(0xFF, 0xEF, 0xC3);
static constexpr color LAKE(0xAA, 0xDA, 0xFF);
static constexpr color ISLAND(0xF2, 0xF2, 0xF2);
static constexpr color BUILDING(0xE0, 0xE0,0xE0);
static constexpr color HIGHWAY(255, 235, 161);
static constexpr color BACKGROUND(0xF2, 0xF2,0xF2);
static constexpr color STREET_FOUND_BLUE(0x66, 0x9d,0xF6);
static constexpr color HIGHWAY_OUT(246, 207, 101);
}
